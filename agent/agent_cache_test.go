...
func createTestCacheData() map[string]any {
...
func TestCacheMultipleIntervals(t *testing.T) {
	synctest.Test(t, func(t *testing.T) {
		cache := newDataCache()
		data1 := map[string]any{"status": "ok", "source": "interval-500"}
		data2 := map[string]any{"status": "ok", "source": "interval-1000"}
...
func TestCacheOverwrite(t *testing.T) {
	cache := newDataCache()
	data1 := map[string]any{"value": 1}
	data2 := map[string]any{"value": 2}
