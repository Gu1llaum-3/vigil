...
try {
    ...
    $scriptUrl = "https://raw.githubusercontent.com/Gu1llaum-3/vigil/main/supplemental/scripts/upgrade-agent.ps1"
    $tempScriptPath = "$env:TEMP\vigil-upgrade-agent-$(Get-Date -Format 'yyyyMMdd-HHmmss').ps1"
